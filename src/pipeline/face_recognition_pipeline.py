...
class FaceRecognitionPipeline:
    def __init__(self, db_path: str = "img_real", model_name: str = "Facenet", threshold: float = 0.7):
        self.rec = Recognizer(db_path=db_path, model_name=model_name, threshold=threshold)
...
if __name__=="__main__":
    ...
    pipe = FaceRecognitionPipeline(db_path= "img_real", model_name= "Facenet", threshold= 0.7)
