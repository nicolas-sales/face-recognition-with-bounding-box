...
MODEL_PATH = str(Path(__file__).parent / "yolov8n-face.pt")

det = FaceDetectionPipeline(model_path = MODEL_PATH, device = device, conf = 0.25)
rec = FaceRecognitionPipeline(db_path = "img_real", model_name = "Facenet", threshold = 0.4, detector_backend="retinaface") # plus robuste
